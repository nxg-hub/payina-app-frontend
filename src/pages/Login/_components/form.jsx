...
import useAuth from 'src/useAuth'; // Ensure this path is correct
...
//           localStorage.setItem('authToken', token);
//
//           // Fetch registration level
//           const levelResponse = await fetch(import.meta.env.VITE_REG_LEVEL_ENDPOINT, {
//             headers: {
...
//           } else {
//             console.error('Failed to fetch registration level');
//           }
//
//           console.log('Log in successful:', token);
