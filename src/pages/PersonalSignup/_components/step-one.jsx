...
export const StepOne = ({ next }) => {
  ...
  // const handleToggle = () => {
  //   navigate('/signup'); // Navigate to /signup when toggled
  // };

  return (
    <>
      <div className="text-center mt-15 xl:mt-0 text-primary font-extrabold xl:text-5xl text-2xl">
        Sign up to Payina
      </div>
          ...
          {() => (
            <Form className="w-full space-y-4">
              <div className="xl:py-16 p-4 pt-[2.2rem] xl:p-10 xl:pl-[5rem] xl:pr-40 xl:w-auto w-full m-auto xl:space-y-8 space-y-4 pb-2 xl:pb-6">
                <div className="text-lightBlue text-center font-bold xl:text-[32px] text-xl">
                  Personal Signup
                </div>
