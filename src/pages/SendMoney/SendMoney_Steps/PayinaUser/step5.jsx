...
const SuccessMessage = () => {
  return (
    <div className="flex flex-col justiify-center items-center xl:ml-80 xl:pt-28 md:pt-10 mx-auto mt-5 gap-5">
      <div className="text-xl md:text-3xl font-medium text-left">Send Money</div>
      <div className="main-message flex flex-col justify-center items-center gap-2">
        <div className="img">
