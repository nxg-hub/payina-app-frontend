...
const Terms = () => {
  ...
  return (
    <section className="bg-black">
      ...
      <div
        id="terms-document"
        className="flex flex-col justify-center text-white items-center gap-10 p-5 lg:p-10 lg:mx-auto">
        <div className="flex flex-col justify-center items-center gap-3">
          <h1 className="hedText text-3xl font-bold text-center">
            Payina Payment Solution Terms of Use
          </h1>
          <p className="headText text-[17px] font-medium leading-6 w-full lg:w-[50vw] text-center">
          ...
          <button
            type="submit"
            onClick={downloadPdf}
            className="rounded-full text-lightBlue text-xs md:text-base py-[10px] px-[30px] border border-lightBlue bg-yellow hover:bg-[#FFb950] hover:bg-yellow-400 transition-all transform hover:scale-105 hover:animate-bounce">
            Download Page
          </button>
        </div>
        <div
        ...
        <div
          id="terms-content"
          className="termsText flex flex-row gap-10 lg:mt-10 px-5 lg:px-10 py-2">
              ...
              {[
                ...
                return (
                  <li key={index} className="cursor-pointer">
                    <div
                      className={`py-2 px-2 text-lg ${isActive ? 'text-yellow font-bold' : 'text-white'} hover:text-lightBlue`}
...
const Section = ({ id, title, content }) => {
  ...
  return (
    <div id={id.toLowerCase()} className="scroll-mt-28">
      ...
      <p className="text-[17px] text-gray-700">{renderContent()}</p>
    </div>
  );
};
