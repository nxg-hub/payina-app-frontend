    ...
    <section className="text-primary w-full h-screen">
      ...
      <div className=" container">
        ...
        <form>
          ...
          <div className="flex flex-col text-primary w-[64%] ">
            <label className="py-4">Email</label>
            <input
              type="email"
              placeholder="Enter Email address"
              className="border-2 rounded-[5px] px-5 py-2 border-primary bg-black text-primary"
            />
          </div>
          ...
          <div className="flex flex-col w-[64%] ">
            ...
            <input
              ...
              className="border-2 rounded-[5px] px-5 py-2 border-primary bg-black "
            />
          </div>
          <div className="flex flex-col w-[64%] ">
