        ...
        <form>
             ...
             w-[64%] bg-neutral px-4 py-2">Review Your Order </button>
                     ...
                     <div className="flex text-primary flex-col w-[64%] ">
                        ...
                        <input type="text" placeholder="EnterCardNumber" 
                        className="border-2 mt-2 mb-2 border-slate-300 rounded-[5px] px-2 py-1 border-primary bg-black text-slate-600"
                        />
                     </div>
                     <div className="flex text-primary flex-col w-[64%] ">
                        <label className="pt-4">Name On Card</label>
                        <input type="text" placeholder="EnterNameOnCard" 
