...
const Debits = () => {
  return (
    ...
    <p className='py-2 md:py-3 px-2 md:px-6 border border-[#D9D9D9] font-bold text-[7.5px] md:text-base'>Recent Debit Transactions</p>
    ...
    <div className="flex flex-col border border-[#D9D9D9]">
      ...
      <div className='flex items-center'>
        ...
        <span className="font-medium  text-[7px] md:text-base border border-[#E80516] text-[#E80516] py-1 md:py-2 px-[5.5px] md:px-6">Direct Transfer</span>
