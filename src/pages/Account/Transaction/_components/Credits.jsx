...
const Credits = () => {
  return (
    ...
    <p className='py-2 md:py-3 px-2 md:px-6 border border-[#D9D9D9] font-bold text-[7.5px] md:text-base'>Recent Credit Transactions</p>
    <div className="flex flex-col border border-[#D9D9D9] "> 
      ...
      <div className='flex'>
        ...
        <span className="font-medium  text-[7.5px]   md:text-base xl:pl-8 md:pl-10 pl-5  ">Source</span>
        <span className=" text-[7.5px] md:text-base sm: md:pl-7 lg:  xl:pl-14 pl-5   sm:pl-4"> Date</span>
        <span className=" text-[7.5px] md:text-base  md:pl-8 xl:pl-11 sm:pl-1">
        Status
        </span>
    ...
    <div className="flex flex-col border border-[#D9D9D9]">
      ...
      <div className='flex items-center'>
        ...
        <span className="font-medium  text-[7px] md:text-base border border-[#0C4E06] text-[#0C4E06] py-1 md:py-2 px-[5.5px] md:px-6">Direct Transfer</span>
    ...
    <div className="flex flex-col border border-[#D9D9D9]">
      ...
      <div className='flex items-center'>
        ...
        <span className="font-medium  text-[7.5px] md:text-base border border-secondary text-secondary py-1 md:py-2 px-2 md:px-6">Paid Invoice</span>
        <span className=" text-[7.5px] md:text-base">Aug, 27 2023</span>
        <span className="border border-[#0C4E06] text-[#0C4E06] text-[7.5px] md:text-base py-1 md:py-2 px-[6px] md:px-6">
          Successful
        </span>
