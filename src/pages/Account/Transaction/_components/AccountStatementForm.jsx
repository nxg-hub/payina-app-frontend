...
const AccountStatementForm = () => {
  ...
  return (
    <div className="">
      ...
      {success && (
        <>
          <div className="bg-[#CCDFE6] z-[55] border-[#CCDFE6] border shadow-2xl rounded-md h-[200px] w-[80%] left-[10%] md:w-[35%] m-auto absolute top-[300px] md:top-[15%] md:left-[35%]">
      ...
      {viewTransaction && (
        <div className=" z-[60] h-[500px] w-[80%] md:w-[70%] left-[10%] md:left-[20%] overflow-y-scroll rounded-md overflow-x-scroll md:overflow-x-hidden border shadow-md fixed top-[160px] md:top-[10%] m-auto bg-[#CCDFE6]">
