        ...
        <div className="px-6 py-4 shadow-[rgba(50,_50,_105,_0.4)_0px_2px_5px_1px,_rgba(0,_0,_0,_0.03)_0px_1px_1px_0px] ">
          ...
          <Formik
            ...
            {({
              ...
              <Form className="flex flex-col  w-full py-4 space-y-4">
                {step === 1 && (
                  <>
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          validateForm().then((errors) => {
                            ...
                            const stepOneErrors = Object.keys(errors).filter(
                              (key) =>
                            ...
                            fetch(
                              ...
                              .then((data) => {
                                if (data.exists) {
                                  ...
                                  fetch(
                                    `${import.meta.env.VITE_GET_USER_BY_EMAIL_ENDPOINT}?email=${values.employeeEmailAddress}`
                                  )
                                    .then((res) => res.json())
                                    .then((userData) => {
                                      if (userData.accountNumber) {
                                    ...
                                    .catch((error) =>
                                      setErrorMessage('Error fetching user details:', error.message)
                                    );
                                } else {
                                  setLoading(false);
                                }
