...
const Scan = () => {
  ...
  const isUrl = (str) => {
    try {
      // This will throw an error if str is not a valid URL
      new URL(str);
      // Only return true for http or https URLs
  ...
  return (
    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex h-screen bg-gray-100 mt-28 flex-1 overflow-y-auto p-6">
