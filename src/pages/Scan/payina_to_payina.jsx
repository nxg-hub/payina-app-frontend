...
//     link.download = 'payina-qr-code.png';
//     link.href = url;
//     link.click();
//   };
//
...
//         <button
//           className={`flex-1 py-2 px-4 ${activeTab === 'generate' ? 'bg-lightBlue text-white' : 'bg-gray-200'}`}
//           onClick={() => setActiveTab('generate')}>
//           Generate QR
//         </button>
//         <button
//           className={`flex-1 py-2 px-4 ${activeTab === 'scan' ? 'bg-lightBlue text-white' : 'bg-gray-200'}`}
...
//           />
//           <CustomButton onClick={generateQR} disabled={loading} className="w-full">
...
//               </p>
//               <CustomButton onClick={downloadQR} className="mt-2">
//                 Download QR Code
//               </CustomButton>
//             </div>
//           )}
...
//             </CustomButton>
//             <CustomButton onClick={() => fileInputRef.current?.click()} className="flex-1">
//               Upload QR Code
//             </CustomButton>
//             <input
//               type="file"
        ...
        <div className="flex h-screen bg-gray-100 mt-28">
          <div className="flex-1 flex flex-col overflow-hidden">
            <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md">
              ...
              {/* Transfer Mode Toggle - Beautiful Design */}
