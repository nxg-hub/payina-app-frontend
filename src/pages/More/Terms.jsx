  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="flex">
        ...
        {/* Main Content */}
        <div className="w-full mt-12 md:ml-[25%] md:pr-[4%] px-[5%] md:w-auto">
          <h1 className="text-2xl font-bold text-center text-primary mb-4">Terms of Service</h1>
          ...
          <h2 className="text-lg font-semibold mb-2">3. Service Availability</h2>
          <p className="text-sm text-gray-700 mb-4">
          ...
          <h2 className="text-lg font-semibold mb-2">4. Modifications</h2>
          <p className="text-sm text-gray-700 mb-4">
