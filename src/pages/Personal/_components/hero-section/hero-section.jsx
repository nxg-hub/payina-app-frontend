  ...
  return (
    <section className="xl:py-20 py-10 xl:pt-0 px-10 bg-[#000]">
      ...
      <div className="md:items-center flex flex-col">
        <div className="lg:text-5xl md:w-1/2 md:text-center xl:text-[64px] text-4xl flex justify-center font-bold text-lightBlue pt-10 !leading-normal">
          Manage money on the go, anytime, anywhere
        </div>
        <p className="text-xl font-normal xl:w-1/2 text-primary lg:pt-6 pt-4 md:text-center leading-normal">
          EChoose us for a transformative financial experience—where innovation meets reliability.
        ...
        <p className="xl:mt-12 text-2xl font-bold text-primary">Download Payina App</p>
