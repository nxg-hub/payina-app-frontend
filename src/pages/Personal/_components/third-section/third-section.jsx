  ...
  return (
    <div className="bg-[#000] flex justify-center items-center  xl:pb-4 xl:pt-4">
      <div className='relative'>
        <img src={section3} alt="security"  className='xl:mb-10 xl:mt-10 h-[350px] md:h-full ' />
        <div className='bg-primary px-2 py-4 h-[88%] md:px-10 md:py-10 w-[38%] md:h-fit absolute md:right-[3rem] right-[.5rem] md:top-[13rem] top-[2.5rem] text-lightBlue flex items-center justify-center flex-col rounded-[8.34px]'>
