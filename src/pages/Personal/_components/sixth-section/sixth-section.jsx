  ...
  return (
    <div className='bg-[#000]'>
      ...
      <div className=' py-16 text-primary grid md:grid-cols-3 px-8   gap-8 md:pr-[100px]   ' >
        <div className='w-full grid  place-content-center '>
         ...
         <p className=' '>
          ...
          <button className='bg-[white] w-[200px] rounded-md font-medium my-6  py-3 text-lightBlue hidden md:hidden lg:inline-block '>See more reviews</button>
        </div>
      ...
      <div className='grid place-content-end pr-4 '>
          <button className='bg-[white] w-[200px] rounded-md  font-medium  mx-auto  py-3 text-lightBlue'>See more reviews</button>
          </div>
