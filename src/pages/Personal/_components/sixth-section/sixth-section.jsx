...
const SixthSection = () => {
  return (
    <div className='bg-[#000]'>
      <div className='flex flex-row text-primary py-12 px-12'>
      ...
      <div className=' py-16 text-primary grid md:grid-cols-3 px-8   gap-8 md:pr-[100px]  md:pl-[100px] ' >
        <div className='w-full grid place-content-center '>
          ...
          <p>Happy customers make us happy!</p>
          <button className='bg-[white] w-[200px] rounded-md font-medium my-6 mx-auto  py-3 text-lightBlue'>See more reviews</button>
        </div>
