          ...
          <div className="py-16">
            <div className="md:space-y-0 p-10 flex-row-reverse md:flex justify-center">
              <div className="text-2xl md:text-4xl items-center flex w-full md:w-[40%] order-2 md:order-1">
                ...
                <div className="hidden xl:block absolute w-[200px] bottom-[45.35rem] right-[15rem] h-[250px] bg-[#0E8CBD] rounded-b-[10px]" />
              ...
              <div className="hidden md:ml-[-4rem] xl:ml-0 xl:block absolute w-[200px] bottom-0 md:left-[3rem] h-[250px] bg-[#0E8CBD] rounded-t-[10px]" />
            </div>
          </div>
        </div>
      </div>
